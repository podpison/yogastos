...
export const MobileMenu: React.FC<Props> = ({ isOpen, closeBurger }) => {
  ...
  return <div className="flex flex-col items-center absolute w-[calc(100%_+_8px)] ml-[-4px] bg-white mt-[-8px] py-4 min-h-[178px] top-2 md:hidden">
    ...
    <Logo />
    <Nav onClick={closeBurger} className="mt-5 gap-y-2 flex-col text-center" />
  </div>
};